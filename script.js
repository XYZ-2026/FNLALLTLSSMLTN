...
// GAS_URL removed as part of Firestore migration
...
async function handleLogin(e) {
  ...
  try {
    const response = await authApi('loginUser', { email, password: encodePassword(password) });
    ...
    showErr(err, 'Could not connect to authentication service.');
  }
...
async function loadShiftData(shift) {
  ...
  const fileMap = {
    easy_to_moderate: 'Easy to Moderate Marks vs percentile.json',
    moderate: 'Moderate marks vs percentile.json',
    moderate_to_difficult: 'Moderate to Difficult Shift marks vs percentile.json',
    difficult: 'Difficult Shift marks vs percentile.json'
  };
...
/* ══════════════════════════════════════════════════════════════
   ...
   ══════════════════════════════════════════════════════════════ */
// Legacy gasRequest function removed. Using authApi (shared_auth.js) now.
